...
export default keyMirror({
  ...
  GET_SELECTED_TEMPLATE_DATA: Symbol('GET_SELECTED_TEMPLATE_DATA'),
  ...
  REMOVE_ALL_NOTIFICATIONS: Symbol('REMOVE_ALL_NOTIFICATIONS'),

  OPEN_COLORPICKER: Symbol('OPEN_COLORPICKER'),
  SET_COLOR_FROM_COLORPICKER: Symbol('SET_COLOR_FROM_COLORPICKER'),
  CLOSE_COLORPICKER: Symbol('CLOSE_COLORPICKER'),

  SET_SWATCH: Symbol('SET_SWATCH'),
  SET_FONT: Symbol('SET_FONT')
});